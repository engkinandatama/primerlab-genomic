...
* **[Quick Start](/docs/guides/quickstart)**: Design your first primers in 5 minutes.
* **[Guides](/docs/guides/index)**: Step-by-step tutorials for PCR, qPCR, and more.
* **[Reference](/docs/reference/cli)**: CLI commands, API docs, and configuration.
* **[Concepts](/docs/concepts/index)**: Learn about scoring, algorithms, and quality control.
...
Learn more: [System Architecture](/docs/concepts/architecture)
