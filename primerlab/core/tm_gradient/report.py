...
def generate_tm_gradient_markdown(
    ...
    lines = [
        ...
        "## Configuration",
        "",
        f"- **Temperature Range**: {config['min_temp']}°C - {config['max_temp']}°C",
        f"- **Step Size**: {config['step_size']}°C",
        "",
        "## Optimal Annealing Temperature",
        "",
        f"🎯 **Recommended Temperature**: **{optimal['optimal']:.1f}°C**",
        "",
        f"| Parameter | Value |",
        f"|-----------|-------|",
        f"| Optimal | {optimal['optimal']:.1f}°C |",
        f"| Range Min | {optimal['range_min']:.1f}°C |",
        f"| Range Max | {optimal['range_max']:.1f}°C |",
        "",
        "## Per-Primer Results",
        "",
        "| Primer | Tm (°C) | Optimal Annealing | Grade |",
        "|--------|---------|-------------------|-------|",
    ]
